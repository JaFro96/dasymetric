...
tmap::tm_shape(population_counts) + tmap::tm_polygons("pop_counts")
```
...
dm_pop = dasymetric_map(population_counts, source, urban_fabric, extensive = "pop_sum")
tmap::tm_shape(dm_pop) + tmap::tm_polygons("pop_sum")
# plot(dm_pop["pop_sum"],main="Dasymetric population map based on land use information (2018)")
```
