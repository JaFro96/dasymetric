...
tmap::tm_shape(population_counts) + tmap::tm_polygons("population", title = "Census data (2018)")
tmap::tm_shape(dm_pop) + tmap::tm_polygons("pop_prediction", title = "DM-interpolation (landuse)")
tmap::tm_shape(dm_pop_buildings) + tmap::tm_polygons("pop_prediction", title = "DM-interpolation (buildings)")
```
