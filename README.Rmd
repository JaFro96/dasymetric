...
plot(population_counts["pop_counts"],lwd = 2, main="Population (2018)")
```

That's how the population is distributed using area-weighted interpolation:

```{r aw-interpolation, echo = FALSE}
require(areal)
# total population
print(sum(population_counts["pop_counts"]$pop_counts)) # 310610
# big polygon
...
plot(aw_pop["pop_sum"],main="Area-weighted Interpolation of Population (2018)")
```

```{r dasymetric method, echo = FALSE}
# TODO: plot dasymetric result
```
